"""Обработчик счета теннисного матча.

Этот модуль отвечает за логику обновления счета в матче - обычные игры, тай-брейк, сеты.
"""
import logging


class ScoreHandler:
    """Класс для управления счетом в теннисном матче."""

    def __init__(self):
        """Инициализация обработчика счета."""
